...
#include "feature_tracker/msg/cloud_info.hpp"
...
private:
    ...
    rclcpp::Publisher<feature_tracker::msg::CloudInfo>::SharedPtr pubLaserCloudInfo;
    ...
    feature_tracker::msg::CloudInfo cloudInfo;
    double timeScanCur;
    double timeScanEnd;
...
public:
    ImageProjection(const rclcpp::NodeOptions & options) :
            ParamServer("feature_tracker_imageProjection", options), deskewFlag(0)
    {
        ...
        // subOdom = create_subscription<nav_msgs::msg::Odometry>(odomTopic + "_incremental", qos_imu,std::bind(&ImageProjection::odometryHandler, this, std::placeholders::_1),odomOpt);
        // LIDAR 
        subOdom = create_subscription<nav_msgs::msg::Odometry>("/vins_estimator/imu_propagate_ros", qos_imu,std::bind(&ImageProjection::odometryHandler, this, std::placeholders::_1),odomOpt);
        subLaserCloud = create_subscription<sensor_msgs::msg::PointCloud2>(pointCloudTopic, qos_lidar,std::bind(&ImageProjection::cloudHandler, this, std::placeholders::_1),lidarOpt);

        pubExtractedCloud = create_publisher<sensor_msgs::msg::PointCloud2>("feature_tracker/deskew/cloud_deskewed", 1);
        pubLaserCloudInfo = create_publisher<feature_tracker::msg::CloudInfo>("feature_tracker/deskew/cloud_info", qos);
    ...
    void publishClouds()
    {
        ...
        // LIDAR
        cloudInfo.cloud_deskewed  = publishCloud(pubExtractedCloud, extractedCloud, cloudHeader.stamp, "body");
